...
## Switches
set_property PACKAGE_PIN W16 [get_ports sys_pause]					
	set_property IOSTANDARD LVCMOS33 [get_ports sys_pause]
...
##Buttons
set_property PACKAGE_PIN U18 [get_ports {continue}]						
	set_property IOSTANDARD LVCMOS33 [get_ports {continue}]
set_property PACKAGE_PIN T18 [get_ports {player1_controls[1]}]						
	set_property IOSTANDARD LVCMOS33 [get_ports {player1_controls[1]}]
set_property PACKAGE_PIN W19 [get_ports {player2_controls[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {player2_controls[1]}]
set_property PACKAGE_PIN T17 [get_ports  {player2_controls[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {player2_controls[0]}]
set_property PACKAGE_PIN U17 [get_ports {player1_controls[0]}]						
	set_property IOSTANDARD LVCMOS33 [get_ports {player1_controls[0]}]
